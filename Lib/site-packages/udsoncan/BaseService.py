...
class BaseService(ABC):
    ...
    def __get_all_subclasses(cls) -> List[Type["BaseService"]]:
        ...
        # cases where a CAN message is similar to one found in official UDS1 documentation but has a different service ID
        # This also allows for custom UDS1 service creation where a nonstandard extension is more easily played ontop of the protocol
        lst = []
    ...
    @classmethod  # Tells if the given response code is expected for this service according to UDS1 standard.
