...
class Units:
    ...
    class Prefixs:
        class Prefix:
            ...
            def __repr__(self) -> str:
                ...
                return "<UDS1 Unit prefix : %s[%s] %swith ID=%d at %08x>" % (self.name, self.symbol, desc, self.id, id(self))
    ...
    class Unit:
        ...
        def __repr__(self):
            ...
            return "<UDS1 Unit : %s[%s] %swith ID=%d at %08x>" % (self.name, self.symbol, desc, self.id, id(self))
