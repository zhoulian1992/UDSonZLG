...
class DataFormatIdentifier:
    ...
    :param compression: Value between 0 and 0xF specifying the compression method. Only the value 0 has a meaning defined by UDS1 standard and it is `No compression`.
            All other values are ECU manufacturer specific.
    :type compression: int 

    :param encryption: Value between 0 and 0xF specifying the encryption method. Only the value 0 has a meaning defined by UDS1 standard and it is `No encryption`.
            All other values are ECU manufacturer specific.
    :type encryption: int
